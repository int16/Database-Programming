		...
		private void initialiseColumnNames() 
		{
			...
			else
			{
				JOptionPane.showMessageDialog(null,
						"Weird number of arrows per end. Can't deal with this.",
						"Wrong Input",
	...
	private void processScore()
	{
		...
		if(rsdp.claimAward())
		{
			try
			{
				...
				types = misc.getAwardTypeForEndScores();
			...
			else
			{
				...
				if(score.isClaimAward())
				{
					...
					for (int i = 0; i < score.getAwards().size(); i++)
					{
						...
						sb.append("Saved "+a.getAwardType().getDescription()+" for "+a.getRange().getDistance()
								+"m, "+a.getRange().getFace().getDescription()+" face.\n");
					}
