...
import gui.EventEditingPN.CheckBoxListener;
...
public class RoundScoreDetailsPN extends JPanel 
{
	...
	public RoundScoreDetailsPN(Equipment[] equip, ArrayList<EventLevel> lvl)
	{
		...
		if(displayableLevels == null)
			makeDisplayableLevels();
	...
	public void addDetailsToScore(Score score)
	{
		...
		try
		{
			...
			if (eventCB.getSelectedIndex() > -1)
				score.setEvent(events[eventCB.getSelectedIndex()]);
