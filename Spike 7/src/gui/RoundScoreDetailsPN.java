...
public class RoundScoreDetailsPN extends JPanel {
		...
		public void actionPerformed(ActionEvent ae) {
			if (ae.getSource().equals(eventCB)) {
				...
				try {
					...
					Event event = events[idx]; // Event
					Score score = service.selectScore(archer, event);
	...
	private void populateTable() {
		scoresTP.setTableData(score);
	}
	
	private void setActiveScore(Score score) {
		this.score = score;
	}
