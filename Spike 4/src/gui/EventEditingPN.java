...
public class EventEditingPN extends JPanel {
	...
	public void initialisePanel(Discipline[] discs)
	{
		...
		if(multiEvents == null)
		{
			...
			{
				JOptionPane.showMessageDialog(this,
						"Can't find multi-event competitions in database.",
						"Data Retrieval Problem",
						JOptionPane.ERROR_MESSAGE);
			}
	...
	private void doSaveAction()
	{
		try
		{
			...
			if(multiEventCB.getSelectedIndex() >= 0)
				e.setMultiEvent(multiEvents[multiEventCB.getSelectedIndex()]);
